...
from api.dependencies import PaginationDep, ProjectDataCreateDep, ProjectServiceDep
import schemas
...
async def create_project(data: ProjectDataCreateDep, user_service: ProjectServiceDep):
